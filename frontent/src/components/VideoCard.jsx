...
import { formatTimeAgo, formatNumber, formatDuration, getVideoThumbnail, getUserAvatar } from '../utils/helpers';
...
const VideoCard = ({ video, className = '' }) => {
  ...
  return (
    <div className={`bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all duration-200 animate-fade-in ${className}`}>
      {/* Thumbnail */}
